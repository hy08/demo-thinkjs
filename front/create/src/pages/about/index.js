...
class Index extends React.Component {
  ...
  componentDidMount() {
    // 请求数据
    const { links, contentType } = this.state;
    switch (contentType) {
    ...
    return (
      <>
        ...
        <div className={styles.introContent}>
          <p>
            <span className={styles.companyName}>{companyName}</span>成立于1995年，至今有24年历史，位于江苏省昆山市（毗邻上海市），现有员工180名，三年以上员工占比80%，占地4万平方米，建有现代化标准厂房2万平方米以及2万平方的智能化工厂，主要产品: 单卡盒 、精裱盒、手提纸袋、瓦楞彩盒、说明书等。拥有专业设计 – 快速打样 – 个性化定制 –智能化制造及物流系统等行业优势.
          </p>
